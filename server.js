  ...
  fetch(
    ...
    .then((data) => {
      ...
      weather and extract a part of it*/
            //FIXME: const iconId = data.current.condition.icon.substr(
            //   "//cdn.weatherapi.com/weather/64x64".length
            // );
      /*reformat the icon url to your own
      local folder path and add it to the page*/
      // Assuming you have a mapping of weather codes to gif filenames
      // FIXME: const weatherCodeToGif = {
      //   1000: 'clear.gif',
      //   1003: 'partly_cloudy.gif',
      //   1006: 'cloudy.gif',
      //   // Add more mappings as needed
      // };

      // // Get the gif filename corresponding to the weather code
      // const gifFilename = weatherCodeToGif[code];

      // // If a gif filename was found, use it, otherwise use a default gif
